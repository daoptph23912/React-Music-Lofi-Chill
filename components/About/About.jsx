  ...
  return (
    <div className='container'>
      <nav className='container__nav'>
        ...
        <div className='nav-menu'>
          <a
            target='_blank'
            rel='noreferrer'
            href='https://www.linkedin.com/in/%C4%91%E1%BA%A1o-ph%E1%BA%A1m-049733285'
          >
      ...
      <section className='description'>
        <h1>Welcome to the auto genrate lofi music made by Thanh Dao</h1>
        <h1>The purpose of this application is for learning</h1>
        <h1>This is a web application inspired by Lofi</h1>
        <h1>
